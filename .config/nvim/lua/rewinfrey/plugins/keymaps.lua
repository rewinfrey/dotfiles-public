return {
  {
    ...
    init = function()
      ...
      wk.add({
        ...
        { "<leader>ff", ":NERDTreeFind<CR>", desc = "Find in NERDTree" },
        { "<leader>n", ":edit $HOME/Library/Mobile Documents/com~apple~CloudDocs/Documents/Notes<CR>", desc = "Open Notes" },
        ...
        { "<C-l>", 'copilot#Accept("<CR>")', desc = "Copilot: Accept suggestion", mode = "i", expr = true, replace_keycodes = false },
        ...
        { "<leader>ggc", function() builtin.git_commits() end, desc = "Search Commits" },
        { "<leader>ggf", function() builtin.git_bcommits() end, desc = "Search File History" },
        { "<leader>ggB", function() builtin.git_branches() end, desc = "Git Branches" },
        { "<leader>ggS", function() builtin.git_status() end, desc = "Git Status" },

        -- Telescope / Search
        { "<leader>sc", function() builtin.colorscheme() end, desc = "Select Colorscheme" },
        { "<leader>so", function() builtin.oldfiles() end, desc = "Search Old Files" },
        ...
        { "<leader>sw", function() builtin.grep_string() end, desc = "Search Word" },
        { "<leader>s?", function() builtin.live_grep() end, desc = "Live Grep" },
        { "<leader>sd", function() builtin.diagnostics() end, desc = "Search Diagnostics" },
        { "<leader>st", function() builtin.treesitter() end, desc = "Search Tree-sitter" },
        { "<leader>si", function() builtin.builtin() end, desc = "Search Builtin" },
        { "<leader>s/", function() builtin.current_buffer_fuzzy_find(themes.get_dropdown({})) end, desc = "Fuzzy Search Buffer" },
        ...
        { "<leader>gd", function() builtin.lsp_definitions() end, desc = "Goto Definition" },
        { "<leader>gr", function() builtin.lsp_references() end, desc = "Goto References" },
        ...
        { "<leader>ds", function() builtin.lsp_document_symbols() end, desc = "Document Symbols" },
        { "<leader>ws", function() builtin.lsp_dynamic_workspace_symbols() end, desc = "Workspace Symbols" },
        { "<leader>K", function() vim.lsp.buf.hover() end, desc = "Hover Doc" },
        { "<leader><C-k>", function() vim.lsp.buf.signature_help() end, desc = "Signature Help" },
        ...
        { "<leader>gv", '<cmd>lua require"telescope.builtin".lsp_definitions({jump_type="vsplit"})<CR>', desc = "Goto Definition VSplit" },
        { "<leader>tp", ":TSPlaygroundToggle<CR>", desc = "Toggle TS Playground" },
        { "<leader>rf", function() require("conform").format({ async = true, lsp_fallback = true }) end, desc = "Format Buffer" },
        { "<leader>e", function() vim.diagnostic.open_float() end, desc = "Show Diagnostic Float" },
